...
import {
  ...
  GetManagedRestaurantResponseProps,
...
export function StoreProfileDialog() {
  ...
  function updateManagerRestaurantCache({
    ...
    const cached = queryClient.getQueryData<GetManagedRestaurantResponseProps>([
      'managed-restaurant',
    ])

    if (cached) {
      queryClient.setQueryData<GetManagedRestaurantResponseProps>(
        ['managed-restaurant'],
        {
          ...cached,
          name,
